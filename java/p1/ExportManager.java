...
public class ExportManager {
     ...
     *
     * @param task 具体的导出任务，任务内容由每个接口自己定义
     * @param timeout 超时时间（秒）
     * @throws TimeoutException 如果超时
     * @throws InterruptedException 如果线程被中断
     */
    public ByteArrayOutputStream executeExportTask(Callable<ByteArrayOutputStream> task, long timeout) throws TimeoutException, InterruptedException {
        // 提交任务并获取 Future 对象
        Future<ByteArrayOutputStream> future = executorService.submit(task);
