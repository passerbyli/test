...
const loadData = async () => {
    dataSources.value = await getAllSources();
    activeId.value = await getActiveSourceId();
};
...
const testConnection = async (row) => {
    const result = await window.electron.invoke('test-connection', row);
